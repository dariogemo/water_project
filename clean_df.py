...
def clean_df():
    ...
    df = pd.DataFrame(df)
    df.drop([22, 21, 20, 19, 18, 17, 0], axis = 1, inplace = True)
    ...
    for target in ['Iron', 'Nitrate', 'Lead', 'Color', 'Turbidity', 'Manganese']:
    ...
    for target in ['Iron', 'Nitrate', 'Chloride', 'Lead', 'Zinc', 'Turbidity', 'Fluoride', 'Copper', 'Odor', 'Sulfate', 'Conductivity', 'Chlorine', 'Manganese', 'Total_Diss_Solids']:
